...
const testimonials = [
  {
    ...
    role: "Google Review",
    quote:
      "Dr. Vinola is highly knowledgeable and takes time to clearly explain procedures. I regularly visit for both my son and daughter and am extremely happy with the overall experience.",
    rating: 5,
    initials: "AV",
    color: "#2CB1BC",
  },
  {
    name: "Senthil Kumar Ramasamy",
    role: "Google Review",
    quote:
      "The staff are extremely friendly and welcoming. The waiting area is clean, comfortable and child-friendly. Every treatment room is thoughtfully designed.",
    rating: 5,
    initials: "SR",
    color: "#8B5CF6",
  },
  {
    ...
    role: "Google Review",
    quote:
      "I’ve been visiting Vinola Dental since childhood and it’s the only place my entire family trusts for dental care.",
    rating: 5,
    initials: "AV",
    color: "#F59E0B",
  },
  {
    name: "Parameshwari Shaker",
    role: "Google Review",
    quote:
      "Exceptional care for my child. My 7-year-old with special needs felt comfortable and at ease throughout the visit.",
    rating: 5,
    initials: "PS",
    color: "#EC4899",
  },
  {
    name: "Family Patient Review",
    role: "Google Review",
    quote:
      "Dr. Vinola is kind, patient and makes sure we are completely comfortable during every visit.",
    rating: 5,
    initials: "FP",
    color: "#10B981",
  },
  {
    ...
    role: "Google Review",
    quote:
      "I underwent orthodontic treatment with braces and I am very satisfied with the care and results.",
    rating: 5,
    initials: "SV",
    color: "#6366F1",
  },
              ...
              <div className="flex -ml-4">
                {testimonials.map((t, i) => (
                  <div key={t.name} className="flex-none w-full sm:w-[85%] md:w-[70%] lg:w-[55%] pl-4">
                    <div
                      className={`bg-white rounded-3xl p-8 card-shadow transition-all duration-300 ${i === selectedIndex ? "opacity-100 scale-100" : "opacity-60 scale-95"
                        }`}
                    >
                      {/* Quote icon */}
